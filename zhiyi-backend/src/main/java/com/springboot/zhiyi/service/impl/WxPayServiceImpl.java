...
import com.springboot.zhiyi.config.WxPayConfig;
import com.springboot.zhiyi.model.entity.PointsOrder;
import com.springboot.zhiyi.model.enums.OrderStatus;
import com.springboot.zhiyi.model.enums.wxpay.WxApiType;
import com.springboot.zhiyi.model.enums.wxpay.WxNotifyType;
import com.springboot.zhiyi.model.enums.wxpay.WxRefundStatus;
import com.springboot.zhiyi.model.enums.wxpay.WxTradeState;
...
public class WxPayServiceImpl implements WxPayService {
    ...
    public Map<String, Object> nativePay(Long productId) throws Exception {
        ...
        //生成订单
        PointsOrder orderInfo = pointsOrderService.createOrderByProductId(productId);
        String codeUrl = orderInfo.getQr_code_url();
        if(orderInfo != null && !StringUtils.isEmpty(codeUrl)){
            log.info("订单已存在，二维码已保存");
            //返回二维码
            Map<String, Object> map = new HashMap<>();
            map.put("codeUrl", codeUrl);
            map.put("orderNo", orderInfo.getOrder_no());
            return map;
        }
        ...
        paramsMap.put("description", orderInfo.getRemark());
        paramsMap.put("out_trade_no", orderInfo.getOrder_no());
        paramsMap.put("notify_url", wxPayConfig.getNotifyDomain().concat(WxNotifyType.NATIVE_NOTIFY.getType()));

        Map amountMap = new HashMap();
        amountMap.put("total", orderInfo.getAmount());
        ...
        try {
            ...
            pointsOrderService.saveCodeUrl(orderNo, codeUrl);
    ...
    public void processOrder(Map<String, Object> bodyMap) throws GeneralSecurityException {
        ...
        if(lock.tryLock()){
            try {
                ...
                String orderStatus = String.valueOf(pointsOrderService.getOrderStatus(orderNo));
                ...
                //更新订单状态
                pointsOrderService.updateStatusByOrderNo(orderNo, OrderStatus.SUCCESS);

                //记录支付日志
                pointsPaymentService.createPaymentInfo(plainText);
            } finally {
                //要主动释放锁
                lock.unlock();
            }
